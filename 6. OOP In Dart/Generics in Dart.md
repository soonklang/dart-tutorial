...
กำหนด `class Region<T extends Shape>` เป็น subclass ของ `abstract class Shape` นั่นคือ Circle และ Square
...
สิ่งที่แตกต่างอีกอย่างคือ ชนิดของข้อมูลที่จะใช้กับ generic ใน Java ต้องเป็น reference type เท่านั้น ชนิดข้อมูล primitive type ใช้กับ generic ไม่ได้
 - Dart VS Python
...
ในภาษา C ไม่มี Generics สามารถใช้ Macros เพื่อสร้างโค้ดที่เป็น Generics ดังนั้น ความแตกต่างระหว่าง Dart และ C คือ Dart มี Generics  C ใช้ Macros
