...
ในส่วนนี้คุณจะได้เรียนรู้เกี่ยวกับการสืบทอด (Inheritance) ของคอนสตรักเตอร์ (Constructor) ด้วยวิธีการเปรียบเทียบโค้ดตัวอย่างในภาษาโปรแกรม Dart เมื่อเทียบกับโค้ด ตัวอย่างในภาษาอื่น ซึ่ง**อาจจะ**แสดงกระบวนการที่ใช้ในการหาผลลัพธ์ที่แตกต่างกัน แต่จะให้ผลลัพธ์ที่เหมือนกัน
### จากตัวอย่างที่ 1-5 เมื่อเทียบกับภาษา C 
