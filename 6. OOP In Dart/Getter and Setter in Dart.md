...
## Summary
Getter กับ Setter ในภาษา C++,Java และ Dart มีหน้่าที่หลักคือเป็นตัวที่ใช้เข้าถึงข้อมูลส่วนที่ไม่ต้องการให้มีการดัดแปลง (ทั้งตัวเราหรือโดยคนอื่น) โดยจะจำกัดการเข้าถึง
