...
**ข้อควรระวัง**:
- การใช้ getter และ setter ช่วยให้เราสามารถเพิ่มการตรวจสอบหรือการดำเนินการเพิ่มเติมก่อนที่จะเข้าถึงหรือกำหนดค่าให้กับ properties
...
- **การแยกความรับผิดชอบ:** แต่ละคลาสมีหน้าที่และความรับผิดชอบที่ชัดเจน ทำให้การพัฒนาและการทดสอบง่ายขึ้น.
