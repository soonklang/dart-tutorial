...
```dart
  ...
  if condition:
    ...
    // block of code to be executed if the condition1 is false and condition2 is false
```
จากการเปรียบเทียบ Syntax ของทั้ง 4 ภาษาพบว่า ภาษา Dart,C และ Java มี Syntax ในการเขียนโปรแกรมที่เหมือนกัน แต่ในภาษา Python นั้นแตกต่างออกไป ตัวอย่างเช่น
ในภาษา Python นั้นไม่จำเป็นต้องใส่ () ครอบเงื่อนไขที่กำหนดขึ้นซึ่งไม่เหมือนกับอีก 3 ภาษาที่จำเป็นต้องใส่ อีกสิ่งหนึ่งที่ภาษา Python แตกต่างออกไปคือคำสั่งในการเรียกใช้
เงื่อนไข Else-If ในภาษา Python นั้นใช้เป็นคำสั่ง elif แทนการใช้คำสั่ง else if ซึ่งต่างจากอีก 3 ภาษาที่ใช้เป็นคำสั่ง else
