...
```
# ข้อแตกต่างระหว่างภาษา Dart กับภาษา c ,java, python
# Type Inference
...
## ภาษา C
ภาษา C ไม่มีระบบ nullable types อย่างที่มีในภาษาอื่น ๆ ที่เป็นแบบจังหวะ (dynamically typed) ซึ่งเป็นคุณลักษณะที่ช่วยจัดการกับค่า null ในการประกาศและใช้งานตัวแปร ในภาษา C, ตัวแปรที่ไม่ได้กำหนดค่าเริ่มต้นจะมีค่าไม่ถูกกำหนด (uninitialized) และอาจจะเกิดค่าที่ไม่คาดคิดเมื่อใช้งาน
