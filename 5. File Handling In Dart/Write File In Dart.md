...
แต่ถ้าต้องกาเพิ่มข้อมูลลงในไฟล์ที่มีอยู่โดยไม่ต้องเขียนทับเนื้อหาที่มีอยู่เราสามารถใช้ **FileMode.append** ในการเพิ่มข้อมูลลงไปในไฟล์ที่มีข้อมูลอยู่ก่อนแล้วได้
