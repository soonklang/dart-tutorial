...
2. **การรับค่าเริ่มต้นที่ชัดเจน**<br> ด้วยการระบุค่าเริ่มต้นในพารามิเตอร์แบบชื่อ สามารถแสดงความชัดเจนเกี่ยวกับค่าเริ่มต้นของแต่ละพารามิเตอร์ได้ ทำให้โค้ดอ่านและเข้าใจง่ายขึ้น
