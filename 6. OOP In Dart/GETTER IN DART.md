...
# GETTER IN DART
Getter ใน Dart ใช้ในการรับค่าของคลาส โดยมักถูกใช้เพื่อเข้าถึงค่าของคุณสมบัติที่เป็นส่วนตัวหรือที่เรียก private  โดย Getter จะให้การเข้าถึงอ่านหรือรับข้อมูลค่าของคุณสมบัติของอ็อบเจกต์
...
```
# ตัวอย่างที่ 1 1: Getter In Dart
