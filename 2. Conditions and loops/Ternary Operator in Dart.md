...
> [!IMPORTANT]
> จุดประสงค์หลักของ Ternary Operation คือ ลดจำนวนบรรทัดในการเขียนโค้ด และใช้ในกรณีที่เงื่อนไขไม่ซับซ้อน หากเงื่อนไขมีความซับซ้อนหรือมีการกระทำหลายอย่างที่ต้องประมวลผล ควรใช้ if-else แทนเพื่อให้โค้ดอ่านง่ายและเข้าใจมากขึ้น
