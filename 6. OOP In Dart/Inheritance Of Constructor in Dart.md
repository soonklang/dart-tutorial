...
_code ด้านล่างต่อไปนี้เป็นตัวอย่างในภาษา C Java และ Phyton ซึ่งอาจจะแสดงกระบวนการที่ใช้ในการหาผลลัพธ์ที่แตกต่างกัน แต่จะให้ผลลัพธ์ที่เหมือนกัน เพื่อเปรียบเทียบข้อแตกต่าง_
